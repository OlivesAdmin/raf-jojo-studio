  ...
  return (
    <AppContext.Provider value={{ navigate, route, cart, setCart }}>
      <div className="min-h-screen grain relative" style={{ background: '#06080D', color: '#E2E8F0' }}>
        ...
        <a
          href="https://wa.me/6581234567?text=Hi%20Raf%20%26%20JoJo%20Studio!%20I%27m%20interested%20in%20your%20services."
          target="_blank"
          rel="noopener noreferrer"
          className="fixed bottom-5 right-5 z-50 flex items-center gap-2.5 px-4 py-3 rounded-full shadow-2xl shadow-emerald-600/30 transition-all hover:scale-105 hover:shadow-emerald-500/40"
